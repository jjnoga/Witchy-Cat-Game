...
public class Sounds {
	...
	soundURL[15] = getClass().getResource("/Sounds/endingTheme.wav"); //using
	soundURL[16] = getClass().getResource("/Sounds/hisSound.wav"); //using
	soundURL[17] = getClass().getResource("/Sounds/Clover-Super-Music-Collection-134-Poclo-Sound-Team-Bad-Ending.wav");
