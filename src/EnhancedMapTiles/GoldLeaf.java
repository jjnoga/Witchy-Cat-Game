...
public class GoldLeaf extends EnhancedMapTile {
	protected Sounds sound;
	protected Map map;
	
    public GoldLeaf(Point location, Map testMap) {
        super(location.x, location.y, new SpriteSheet(ImageLoader.load("GoldLeaf.png"),16, 16), TileType.NOT_PASSABLE);
        sound  = new Sounds();
        this.map = testMap;
    }
